...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id="productImg" src="../../assets/Fruits and Vegetables Products/Carrot.png">
            <div class="item_details">
            <h2 class="brand">Georgia's Greens</h2>
            <span class="item_description">Carrots (3 lb avg.)</span>
            
            
            <span id = "price" class = "item_price">$1.99</span></span>
            
            
            <span class="item_price_insight">$0.66/lb</span>
            <div id="quantity-modifier">
              ...
              <input  id = "total" type = "text" value = "1.99$" disabled = "disabled" style = "padding:10px;">
            ...
            <div id = "content-description" class="hideContent">
              ...
              <p class="product_description">Fresh Quebec Carrots</p>
              <br>
              <span class="item_number">Product Number: GGFV004_PK</span>
            </div>
        </div>
    </div></div>
    <div class="footer">
