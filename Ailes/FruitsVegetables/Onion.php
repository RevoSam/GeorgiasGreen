...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id="productImg" src="../../assets/Fruits and Vegetables Products/Onion.png">
            <div class="item_details">
            <h2 class="brand">Georgia's Greens</h2>
            <span class="item_description">Onion (100g avg.)</span>
            ...
            <div id = "content-description" class="hideContent">
              ...
              <p class="product_description">Fresh Red Onions</p>
              <br>
              <span class="item_number">Product Number: GGFV005_PK</span>
            </div>
        </div>
    </div></div>
    <div class="footer">
