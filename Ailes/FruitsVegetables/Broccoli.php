...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id="productImg" src="../../assets/Fruits and Vegetables Products/Broccoli.png">
            <div class="item_details">
            <h2 class="brand">Georgia's Greens</h2>
            <span class="item_description">Broccoli (255g avg.)</span>
            
            
            <span id = "price" class = "item_price">$3.99</span></span>
            
            
            <span class="item_price_insight">$3.99/ea</span>
            ...
            <div id = "content-description" class="hideContent">
              ...
              <p class="product_description">Fresh Broccoli</p>
              <br>
              <span class="item_number">Product Number: GGFV003_PK</span>
            </div>
        </div>
    </div></div>
    <div class="footer">
