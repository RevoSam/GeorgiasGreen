...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id="productImg" src="../../assets/Fruits and Vegetables Products/Banana.png">
            <div class="item_details">
            <h2 class="brand">Georgia's Greens</h2>
            <span class="item_description">Bananas</span>
            
            
            <span id = "price" class = "item_price">$0.62</span></span>
            
            
            <span class="item_price_insight">$0.62/ea</span>
            <div id="quantity-modifier">
              ...
              <input  id = "total" type = "text" value = "0.62$" disabled = "disabled" style = "padding:10px;">
            ...
            <div id = "content-description" class="hideContent">
              ...
              <p class="product_description">Fresh farm bananas.</p>
              <br>
              <span class="item_number">Product Number: GGFV002_PK</span>
            </div>
        </div>
    </div></div>
    <div class="footer">
