  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="..\..\assets/Cleaning Aisle Products/Garbage Bags.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Garbage Bags (50 bags / roll)</span>
        
        <span id = "price" class="item_price">$5.99</span>
        
        <span class="item_price_insight">$0.1198 / bag</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "5.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Kitchen White garbage bags. 50 bags per roll</p>
          <br>
          <span class="item_number">Product Number: GGCP628_LP</span>
        </div>
