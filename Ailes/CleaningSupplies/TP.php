  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="..\..\assets/Cleaning Aisle Products/Toilet Paper.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Soft Double Ply Toilet Paper (242 Sheets - 6 Rolls)</span>
        
        <span id = "price" class="item_price">$6.97</span>
        
        <span class="item_price_insight">$1.162 / ea</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "6.97$" disabled = "disabled" style = "padding:10px;">
        

        </div>
        <a id="add2Cart" href="" class="button">Add to Cart</a>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">High-quality Double Ply Toilet Paper, soft and thick. (6 Rolls - 242 Sheets per Roll)</p>
          <br>
          <span class="item_number">Product Number: GGCP336_QT</span>
        </div>
