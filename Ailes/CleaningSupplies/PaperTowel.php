  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="..\..\assets/Cleaning Aisle Products/Paper Towel.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Strong Paper Towel (2/pkg)</span>
        
        
        <span id = "price" class = "item_price">$3.49</span>
        
        
        <span class="item_price_insight">$1.745 / ea</span>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Ultra Strong Paper Towel, 60 sheets each roll (27.4 x 22.0 cm)</p>
          <br>
          <span class="item_number">Product Number: GGCP225_PK</span>
        </div>
      </div>
      </div>
    </div>
