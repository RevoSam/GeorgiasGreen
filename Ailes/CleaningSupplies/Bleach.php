  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="..\..\assets/Cleaning Aisle Products/Bleach.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Bleach (1.27L)</span>
        <span id = "price" class="item_price">$3.49</span>
        <span class="item_price_insight">$0.003 / ml</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "3.49$" disabled = "disabled" style = "padding:10px;">
        ...
        <p class="product_description">A cleaning solution for cleaning and disinfecting household surfaces</p>
        <br>
        <span class="item_number">Product Number: GGCP101_QF</span>
        </div>
      </div>
      </div>
    </div>
