  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="..\..\assets/Cleaning Aisle Products/Dishwashing.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Dishwashing Liquid (740 ml)</span>
        <span id = "price"  class="item_price">$3.99</span>
        <span class="item_price_insight">$0.005 / ml</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "3.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Powerful grease cutting formula to clean dirty dishes.</p>
          <br>
          <span class="item_number">Product Number: GGCP501_GP</span>
        </div>
