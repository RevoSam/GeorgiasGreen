  ...
  <body>
    ...
    <div class="body">
      ...
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Meat Products/ChickenWhole.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Chicken (Whole)</span>
        
        
        <span id = "price" class = "item_price">$7.99</span></span>
        
        
        <span class="item_price_insight">$7.99 / ea</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "7.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Fresh whole chicken from ethically-raised Canadian farms</p>
          <br>
          <span class="item_number">Product Number: GGMP003_PK</span>
        </div>
    </div>
    <!--End Item Wrapper-->
    </div></div>
