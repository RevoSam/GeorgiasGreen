  ...
  <body>
    ...
    <div class="body">
      ...
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Meat Products/ChickenDR.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Chicken Drumsticks</span>
        
        
        <span id = "price" class = "item_price">$12.99</span></span>
        ...
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "12.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Fresh chicken drumsticks from ethically-raised Canadian farm chickens</p>
          <br>
          <span class="item_number">Product Number: GGMP002_PK</span>
        </div>
    </div>
    <!--End Item Wrapper-->
    </div></div>
