  ...
  <body>
    ...
    <div class="body">
     ...
     <div class="item_wrapper">
      <img id="productImg" src="../../assets/Meat Products/MincedBeef.png">
      <div class="item_details">
      <h2 class="brand">Georgia's Greens</h2>
      <span class="item_description">Minced Beef</span>
      ...
      <div id = "content-description" class="hideContent">
        ...
        <p class="product_description">Fresh minced beef from Canadian farms</p>
        <br>
        <span class="item_number">Product Number: GGMP004_PK</span>
      </div>
  </div>
    <!--End Item Wrapper-->
    </div></div>
