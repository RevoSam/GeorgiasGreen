  ...
  <body>
    ...
    <div class="body">
      ...
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Meat Products/steak.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Steak (Beef)</span>
        
        
        <span id = "price" class = "item_price">$5.49</span></span>
        ...
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "5.49$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Freshly cut breast beef steak.</p>
          <br>
          <span class="item_number">Product Number: GGMP005_PK</span>
        </div>
    </div></div>
    <!--End Item Wrapper-->
    </div>
