  ...
  <body>
    ...
    <div class="body">
      ...
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Meat Products/ChickenBP.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Chicken Breast Pieces</span>
        
        
        <span id = "price" class = "item_price">$13.99</span></span>
        
        
        <span class="item_price_insight">$1.8 / lb</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "13.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Freshly cut breast pieces from ethically-raised Canadian farm chickens</p>
          <br>
          <span class="item_number">Product Number: GGMP001_PK</span>
        </div>
    </div></div>
    <!--End Item Wrapper-->
      </div>
