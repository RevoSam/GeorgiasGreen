...
<body>
    ...
    <div class="body">
        ...
        <div class="item_wrapper">
            <img id = "productImg" src="../../assets/Dairy Products/cheddar-cheese.png" style = "width:500px;">
            <div class="item_details">
                <h2 class="brand">Georgia's Greens</h2>
                <span class="item_description">Cheddar Cheese ( 450 g )</span>
                <span id = "price" class="item_price">$9.99</span>
                <span class="item_price_insight"> $2.22 / 100g </span>
                <div id="quantity-modifier">
                    ...
                    <input  id = "total" type = "text" value = "9.99$" disabled = "disabled" style = "padding:10px;">
                  </div>
                ...
                <div id = "content-description" class = "hideContent">
                    ...
                    <p class="product_description">Good Cheese</p>
                    <br>
                    <span class="item_number">Product Number: SMXL1421_DP</span>
                </div>
            </div>
        </div>
        <!--End Item Wrapper-->
