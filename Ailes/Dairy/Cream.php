...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id = "productImg" src="../../assets/Dairy Products/cream.png">
            <div class="item_details">
                <h2 class="brand">Georgia's Greens</h2>
                <span class="item_description">Cooking Cream ( 470 ml )</span>
                <span id = "price" class = "item_price">$4.99</span>
                <span class="item_price_insight"> $1.061 / 100ml </span>
                <div id="quantity-modifier">
                    ...
                    <input  id = "total" type = "text" value = "4.99$" disabled = "disabled" style = "padding:10px;">
                </div>
                ...
                <div id = "content-description" class = "hideContent">
                    ...
                    <p class="product_description">35% thick cooking cream</p>
                    <br>
                    <span class="item_number">Product Number: SMXL121_DP</span>
                </div>
            </div>
        </div>
        <!--End Item Wrapper-->
