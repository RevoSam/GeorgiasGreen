...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id = "productImg" src="../../assets/Dairy Products/milk-jug.jpg" style = "height:400px">
            <div class="item_details">
                <h2 class="brand">Georgia's Greens</h2>
                <span class="item_description">Skim Milk 2L</span>
                <span id = "price" class="item_price">$7.99</span>
                <span class="item_price_insight">$3.995 / L</span>
                ...
                <div id = "content-description" class = "hideContent">
                    ...
                    <p class="product_description">Good Milk</p>
                    <br>
                    <span class="item_number">Product Number: SMXL2321_DP</span>
                </div>
            </div>
        </div>
    </div>
