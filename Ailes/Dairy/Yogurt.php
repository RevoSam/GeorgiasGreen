...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id = "productImg" src="../../assets/Dairy Products/yogurt.png">
            <div class="item_details">
                <h2 class="brand">Georgia's Greens</h2>
                <span class="item_description">Strawberry Greek Yogurt ( 350 g )</span>
                <span id = "price" class="item_price">$6.99</span>
                <span class="item_price_insight"> $1.997 / 100g </span>
                <div id="quantity-modifier">
                    ...
                    <input  id = "total" type = "text" value = "6.99$" disabled = "disabled" style = "padding:10px;">
                  </div>
                ...
                <div id = "content-description" class = "hideContent">
                    ...
                    <p class="product_description">Good Yogurt</p>
                    <br>
                    <span class="item_number">Product Number: SRW221_DP</span>
                </div>
            </div>
        </div>
    </div>
