...
<body>
    ...
    <div class="body">
        <div class="item_wrapper">
            <img id = "productImg" src="../../assets/Dairy Products/ice-cream.png">
            <div class="item_details">
                <h2 class="brand">Georgia's Greens</h2>
                <span class="item_description">Vanilla Ice Cream (500g)</span>
                <span id = "price" class="item_price">$4.99</span>
                <span class="item_price_insight"> $0.995 / 100g </span>
                ...
                <div id = "content-description" class = "hideContent">
                    ...
                    <p class="product_description">Good Ice Cream</p>
                    <br>
                    <span class="item_number">Product Number: SBVS221_DP</span>
                </div>
            </div>
        </div>
    </div>
