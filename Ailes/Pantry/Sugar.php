  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Pantry/Sugar.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Sugar</span>
        
        
        <span id = "price" class = "item_price">$5.49</span></span>
        
        
        <span class="item_price_insight">$5.49/ea</span>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Medium sized pack of sugar</p>
          <br>
          <span class="item_number">Product Number: GGPP003_PK</span>
        </div>
    </div>
</div></div>
    <div class="footer">
