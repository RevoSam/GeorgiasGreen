  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Pantry/TomatoSauce.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Tomato Sauce</span>
        
        
        <span id = "price" class = "item_price">$4.49</span></span>
        
        
        <span class="item_price_insight">$4.49/ea</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "4.49$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Tomato Sauce, from Italian Tomatoes</p>
          <br>
          <span class="item_number">Product Number: GGPP004_PK</span>
        </div>
    </div>
</div></div>
    <div class="footer">
