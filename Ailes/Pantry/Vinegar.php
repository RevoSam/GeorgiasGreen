  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Pantry/Vinegar.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Vinegar</span>
        
        
        <span id = "price" class = "item_price">$20.99</span></span>
        
        
        <span class="item_price_insight">$20.99/ea</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "20.99$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Fresh Vinegar, Natural Apple Cider</p>
          <br>
          <span class="item_number">Product Number: GGPP005_PK</span>
        </div>
    </div>
</div></div>
    <div class="footer">
