  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Pantry/Flour.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Flour</span>
        
        
        <span id = "price" class = "item_price">$10.49</span></span>
        
        
        <span class="item_price_insight">$10.49/ea</span>
        <div id="quantity-modifier">
          ...
          <input  id = "total" type = "text" value = "10.49$" disabled = "disabled" style = "padding:10px;">
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Fresh Flour</p>
          <br>
          <span class="item_number">Product Number: GGPP002_PK</span>
        </div>
    </div>
</div></div>
    <div class="footer">
