  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Bakery Products/croissant.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Croissants</span>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Butter Croissants, pack containing 4 croissants. </p>
          <br>
          <span class="item_number">Product Number: GGBP003_PK</span>
        </div>
      </div>
    </div>
  </div>
