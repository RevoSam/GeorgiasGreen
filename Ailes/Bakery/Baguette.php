  ...
  <body>
    ...
    <div class="body">
        <div class="item_wrapper">
          <img id="productImg" src="../../assets/Bakery Products/baguette.png">
          <div class="item_details">
          <h2 class="brand">Georgia's Greens</h2>
          <span class="item_description">Baguette</span>
          
          
          <span id = "price" class = "item_price">$0.99</span></span>
          
          
          <span class="item_price_insight">$0.99/ea</span>
          <div id="quantity-modifier">
            ...
            <input  id = "total" type = "text" value = "0.99$" disabled = "disabled" style = "padding:10px;">
          ...
          <div id = "content-description" class="hideContent">
            ...
            <p class="product_description">Loaf of Baguette Bread</p>
            <br>
            <span class="item_number">Product Number: GGBP002_PK</span>
          </div>
        </div>
      </div>
    </div>
