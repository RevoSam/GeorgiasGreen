  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Bakery Products/bagel.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Pack of 4 Freshly Made Bagels</span>
        
        
        <span id = "price" class = "item_price">$5.99</span></span>
        
        
        <span class="item_price_insight">$5.99/ea</span>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Plain Bagel, Pack containing 4 Bagels</p>
          <br>
          <span class="item_number">Product Number: GGBP001_PK</span>
        </div>
    </div>
</div></div>
    </div>
