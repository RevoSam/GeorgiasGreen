  ...
  <body>
    ...
    <div class="body">
      <div class="item_wrapper">
        <img id="productImg" src="../../assets/Bakery Products/wholewheat.png">
          <div class="item_details">
          <h2 class="brand">Georgia's Greens</h2>
          <span class="item_description">Wholewheat Bread</span>
          
          
          <span id = "price" class = "item_price">$3.50</span></span>
          
          
          <span class="item_price_insight">$3.50/ea</span>
          <div id="quantity-modifier">
            ...
            <input  id = "total" type = "text" value = "3.50$" disabled = "disabled" style = "padding:10px;">
          ...
          <div id = "content-description" class="hideContent">
            ...
            <p class="product_description">Loaf of Wholewheat Bread, 650g </p>
            <br>
            <span class="item_number">Product Number: GGBP005_PK</span>
          </div>
        </div>
      </div>
    </div>
