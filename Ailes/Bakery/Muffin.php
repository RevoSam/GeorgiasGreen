...
<html lang="en">
  ...
  <body>
    ...
    <div class="body">
      ...
      <img id="productImg" src="../../assets/Bakery Products/muffin.png">
        <div class="item_details">
        <h2 class="brand">Georgia's Greens</h2>
        <span class="item_description">Pack of 6 Fresh Muffins</span>
        
        
        <span id = "price" class = "item_price">$4.99</span></span>
        
        
        <span class="item_price_insight">$4.99/ea</span>
        ...
        <div id = "content-description" class="hideContent">
          ...
          <p class="product_description">Plain Muffins, pack containing 6 muffins. </p>
          <br>
          <span class="item_number">Product Number: GGBP004_PK</span>
        </div>
      </div>
    </div>
  </div>
